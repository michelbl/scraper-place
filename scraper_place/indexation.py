...
def index_dce(dce_data):
    ...
    data = {
        ...
        'date_limite_remise_plis': dce_data.get('date_limite_remise_plis'),
        'entite_achat': dce_data.get('entite_achat'),
        'procedure': dce_data.get('procedure'),
        'categorie_principale': dce_data.get('categorie_principale'),
        'allotissement': dce_data.get('allotissement'),
        'lieu_execution': dce_data.get('lieu_execution'),
        'code_cpv': dce_data.get('code_cpv'),
